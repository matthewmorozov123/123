...
import { FormEvent, useEffect, useMemo, useRef, useState } from "react";
import { Bot, CalendarCheck, Check, Loader2, MessageCircle, Moon, Send, Sun, X } from "lucide-react";
import { cn, formatTime } from "@/lib/utils";
import type { ChatMessage } from "@/lib/types";
...
const starterPrompts = [
  "How can Brightscale help a med spa?",
            ...
            <div className="mb-3 flex gap-2 overflow-x-auto pb-1">
              {starterPrompts.map((prompt) => (
                <button
                  ...
                  className="shrink-0 rounded-full border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 transition hover:border-bright-blue hover:text-bright-blue dark:border-white/10 dark:text-slate-300 dark:hover:border-bright-cyan dark:hover:text-bright-cyan"
                >
                  {prompt}
                </button>
              ))}
